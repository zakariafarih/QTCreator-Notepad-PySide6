...
enum [[deprecated]] : int {
    ...
    SBK_QOPERATINGSYSTEMVERSIONBASE_OSTYPE_IDX               = 470,
    SBK_QOPERATINGSYSTEMVERSIONBASE_IDX                      = 468,
    ...
    SBK_QPROCESS_UNIXPROCESSFLAG_IDX                         = 500,
    SBK_QFLAGS_QPROCESS_UNIXPROCESSFLAG_IDX                  = 250,
    SBK_QPROCESS_IDX                                         = 486,
    SBK_QPROCESS_UNIXPROCESSPARAMETERS_IDX                   = 502,
    SBK_QPROCESSENVIRONMENT_INITIALIZATION_IDX               = 506,
    SBK_QPROCESSENVIRONMENT_IDX                              = 504,
    SBK_QPROPERTYANIMATION_IDX                               = 508,
    SBK_QRANDOMGENERATOR_IDX                                 = 510,
    SBK_QRANDOMGENERATOR64_IDX                               = 512,
    SBK_QREADLOCKER_IDX                                      = 514,
    SBK_QREADWRITELOCK_RECURSIONMODE_IDX                     = 518,
    SBK_QREADWRITELOCK_IDX                                   = 516,
    SBK_QRECT_IDX                                            = 520,
    SBK_QRECTF_IDX                                           = 522,
    SBK_QRECURSIVEMUTEX_IDX                                  = 524,
    SBK_QREGULAREXPRESSION_PATTERNOPTION_IDX                 = 532,
    SBK_QFLAGS_QREGULAREXPRESSION_PATTERNOPTION_IDX          = 254,
    SBK_QREGULAREXPRESSION_MATCHTYPE_IDX                     = 530,
    SBK_QREGULAREXPRESSION_MATCHOPTION_IDX                   = 528,
    SBK_QFLAGS_QREGULAREXPRESSION_MATCHOPTION_IDX            = 252,
    SBK_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX      = 534,
    SBK_QFLAGS_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX = 256,
    SBK_QREGULAREXPRESSION_IDX                               = 526,
    SBK_QREGULAREXPRESSIONMATCH_IDX                          = 536,
    SBK_QREGULAREXPRESSIONMATCHITERATOR_IDX                  = 538,
    SBK_QRESOURCE_COMPRESSION_IDX                            = 542,
    SBK_QRESOURCE_IDX                                        = 540,
    SBK_QRUNNABLE_IDX                                        = 544,
    SBK_QSAVEFILE_IDX                                        = 546,
    SBK_QSEMAPHORE_IDX                                       = 548,
    SBK_QSEMAPHORERELEASER_IDX                               = 550,
    SBK_QSEQUENTIALANIMATIONGROUP_IDX                        = 552,
    SBK_QSETTINGS_STATUS_IDX                                 = 560,
    SBK_QSETTINGS_FORMAT_IDX                                 = 556,
    SBK_QSETTINGS_SCOPE_IDX                                  = 558,
    SBK_QSETTINGS_IDX                                        = 554,
    SBK_QSHAREDMEMORY_ACCESSMODE_IDX                         = 564,
    SBK_QSHAREDMEMORY_SHAREDMEMORYERROR_IDX                  = 566,
    SBK_QSHAREDMEMORY_IDX                                    = 562,
    SBK_QSIGNALBLOCKER_IDX                                   = 568,
    SBK_QSIGNALMAPPER_IDX                                    = 570,
    SBK_QSIZE_IDX                                            = 572,
    SBK_QSIZEF_IDX                                           = 574,
    SBK_QSOCKETDESCRIPTOR_IDX                                = 576,
    SBK_QSOCKETNOTIFIER_TYPE_IDX                             = 580,
    SBK_QSOCKETNOTIFIER_IDX                                  = 578,
    SBK_QSORTFILTERPROXYMODEL_IDX                            = 582,
    SBK_QSTANDARDPATHS_STANDARDLOCATION_IDX                  = 588,
    SBK_QSTANDARDPATHS_LOCATEOPTION_IDX                      = 586,
    SBK_QFLAGS_QSTANDARDPATHS_LOCATEOPTION_IDX               = 258,
    SBK_QSTANDARDPATHS_IDX                                   = 584,
    SBK_QSTORAGEINFO_IDX                                     = 590,
    SBK_QSTRINGCONVERTER_ENCODING_IDX                        = 594,
    SBK_QSTRINGCONVERTER_IDX                                 = 592,
    SBK_QSTRINGCONVERTERBASE_FLAG_IDX                        = 598,
    SBK_QFLAGS_QSTRINGCONVERTERBASE_FLAG_IDX                 = 260,
    SBK_QSTRINGCONVERTERBASE_IDX                             = 596,
    SBK_QSTRINGCONVERTERBASE_STATE_IDX                       = 600,
    SBK_QSTRINGDECODER_IDX                                   = 602,
    SBK_QSTRINGENCODER_IDX                                   = 604,
    SBK_QSTRINGLISTMODEL_IDX                                 = 606,
    SBK_QSYSINFO_SIZES_IDX                                   = 612,
    SBK_QSYSINFO_ENDIAN_IDX                                  = 610,
    SBK_QSYSINFO_IDX                                         = 608,
    SBK_QSYSTEMSEMAPHORE_ACCESSMODE_IDX                      = 616,
    SBK_QSYSTEMSEMAPHORE_SYSTEMSEMAPHOREERROR_IDX            = 618,
    SBK_QSYSTEMSEMAPHORE_IDX                                 = 614,
    SBK_QTEMPORARYDIR_IDX                                    = 620,
    SBK_QTEMPORARYFILE_IDX                                   = 622,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYTYPE_IDX                 = 628,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX               = 626,
    SBK_QFLAGS_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX        = 262,
    SBK_QTEXTBOUNDARYFINDER_IDX                              = 624,
    SBK_QTEXTSTREAM_REALNUMBERNOTATION_IDX                   = 636,
    SBK_QTEXTSTREAM_FIELDALIGNMENT_IDX                       = 632,
    SBK_QTEXTSTREAM_STATUS_IDX                               = 638,
    SBK_QTEXTSTREAM_NUMBERFLAG_IDX                           = 634,
    SBK_QFLAGS_QTEXTSTREAM_NUMBERFLAG_IDX                    = 264,
    SBK_QTEXTSTREAM_IDX                                      = 630,
    SBK_QTEXTSTREAMMANIPULATOR_IDX                           = 640,
    SBK_QTHREAD_PRIORITY_IDX                                 = 644,
    SBK_QTHREAD_IDX                                          = 642,
...
enum : int {
    ...
    SBK_QOperatingSystemVersionBase_OSType_IDX               = 235,
    SBK_QOperatingSystemVersionBase_IDX                      = 234,
    ...
    SBK_QProcess_UnixProcessFlag_IDX                         = 250,
    SBK_QFlags_QProcess_UnixProcessFlag_IDX                  = 125,
    SBK_QProcess_IDX                                         = 243,
    SBK_QProcess_UnixProcessParameters_IDX                   = 251,
    SBK_QProcessEnvironment_Initialization_IDX               = 253,
    SBK_QProcessEnvironment_IDX                              = 252,
    SBK_QPropertyAnimation_IDX                               = 254,
    SBK_QRandomGenerator_IDX                                 = 255,
    SBK_QRandomGenerator64_IDX                               = 256,
    SBK_QReadLocker_IDX                                      = 257,
    SBK_QReadWriteLock_RecursionMode_IDX                     = 259,
    SBK_QReadWriteLock_IDX                                   = 258,
    SBK_QRect_IDX                                            = 260,
    SBK_QRectF_IDX                                           = 261,
    SBK_QRecursiveMutex_IDX                                  = 262,
    SBK_QRegularExpression_PatternOption_IDX                 = 266,
    SBK_QFlags_QRegularExpression_PatternOption_IDX          = 127,
    SBK_QRegularExpression_MatchType_IDX                     = 265,
    SBK_QRegularExpression_MatchOption_IDX                   = 264,
    SBK_QFlags_QRegularExpression_MatchOption_IDX            = 126,
    SBK_QRegularExpression_WildcardConversionOption_IDX      = 267,
    SBK_QFlags_QRegularExpression_WildcardConversionOption_IDX = 128,
    SBK_QRegularExpression_IDX                               = 263,
    SBK_QRegularExpressionMatch_IDX                          = 268,
    SBK_QRegularExpressionMatchIterator_IDX                  = 269,
    SBK_QResource_Compression_IDX                            = 271,
    SBK_QResource_IDX                                        = 270,
    SBK_QRunnable_IDX                                        = 272,
    SBK_QSaveFile_IDX                                        = 273,
    SBK_QSemaphore_IDX                                       = 274,
    SBK_QSemaphoreReleaser_IDX                               = 275,
    SBK_QSequentialAnimationGroup_IDX                        = 276,
    SBK_QSettings_Status_IDX                                 = 280,
    SBK_QSettings_Format_IDX                                 = 278,
    SBK_QSettings_Scope_IDX                                  = 279,
    SBK_QSettings_IDX                                        = 277,
    SBK_QSharedMemory_AccessMode_IDX                         = 282,
    SBK_QSharedMemory_SharedMemoryError_IDX                  = 283,
    SBK_QSharedMemory_IDX                                    = 281,
    SBK_QSignalBlocker_IDX                                   = 284,
    SBK_QSignalMapper_IDX                                    = 285,
    SBK_QSize_IDX                                            = 286,
    SBK_QSizeF_IDX                                           = 287,
    SBK_QSocketDescriptor_IDX                                = 288,
    SBK_QSocketNotifier_Type_IDX                             = 290,
    SBK_QSocketNotifier_IDX                                  = 289,
    SBK_QSortFilterProxyModel_IDX                            = 291,
    SBK_QStandardPaths_StandardLocation_IDX                  = 294,
    SBK_QStandardPaths_LocateOption_IDX                      = 293,
    SBK_QFlags_QStandardPaths_LocateOption_IDX               = 129,
    SBK_QStandardPaths_IDX                                   = 292,
    SBK_QStorageInfo_IDX                                     = 295,
    SBK_QStringConverter_Encoding_IDX                        = 297,
    SBK_QStringConverter_IDX                                 = 296,
    SBK_QStringConverterBase_Flag_IDX                        = 299,
    SBK_QFlags_QStringConverterBase_Flag_IDX                 = 130,
    SBK_QStringConverterBase_IDX                             = 298,
    SBK_QStringConverterBase_State_IDX                       = 300,
    SBK_QStringDecoder_IDX                                   = 301,
    SBK_QStringEncoder_IDX                                   = 302,
    SBK_QStringListModel_IDX                                 = 303,
    SBK_QSysInfo_Sizes_IDX                                   = 306,
    SBK_QSysInfo_Endian_IDX                                  = 305,
    SBK_QSysInfo_IDX                                         = 304,
    SBK_QSystemSemaphore_AccessMode_IDX                      = 308,
    SBK_QSystemSemaphore_SystemSemaphoreError_IDX            = 309,
    SBK_QSystemSemaphore_IDX                                 = 307,
    SBK_QTemporaryDir_IDX                                    = 310,
    SBK_QTemporaryFile_IDX                                   = 311,
    SBK_QTextBoundaryFinder_BoundaryType_IDX                 = 314,
    SBK_QTextBoundaryFinder_BoundaryReason_IDX               = 313,
    SBK_QFlags_QTextBoundaryFinder_BoundaryReason_IDX        = 131,
    SBK_QTextBoundaryFinder_IDX                              = 312,
    SBK_QTextStream_RealNumberNotation_IDX                   = 318,
    SBK_QTextStream_FieldAlignment_IDX                       = 316,
    SBK_QTextStream_Status_IDX                               = 319,
    SBK_QTextStream_NumberFlag_IDX                           = 317,
    SBK_QFlags_QTextStream_NumberFlag_IDX                    = 132,
    SBK_QTextStream_IDX                                      = 315,
    SBK_QTextStreamManipulator_IDX                           = 320,
    SBK_QThread_Priority_IDX                                 = 322,
    SBK_QThread_IDX                                          = 321,
